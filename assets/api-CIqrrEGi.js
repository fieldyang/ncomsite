import{p as e,c as t}from"./index-BVt-tjJk.js";import"./example-C2ydmLYP.js";import"./proptable-uCA8z-r8.js";import"./eventtable-BHpIrfds.js";import"./filecode-DVjfyq2s.js";const a=[{key:"1",name:"duration",desc:"自动播放间隔时间(ms)，>=2000时有效，否则不自动播放",type:"number",default:"0"},{key:"2",name:"circle",desc:"页号显示为圆点",type:"-",default:"-"},{key:"3",name:"show-button",desc:"显示左右翻页按钮",type:"-",default:"-"}],n=[{key:"1",name:"nc-change",desc:"change事件",params:"e:CustomEvent,e.detail={oldValue:旧页号,value:新页号}"}];class l extends t{template(){return`
    ...
    `}}e("nc-carousel-ex4",s);const d="/assets/1-BniOqsGE.png",h="/assets/2-CuunOXre.png",u="/assets/3-DCsNihuS.jpg",x="/assets/4-S92jblvY.jpg",f="/assets/5-BD2mInm3.jpg";class g extends t{template(){return`
      <nc-carousel style='height:300px;background-color:#000' show-button>
        <img src="${d}" @nc-click={this.toImg} />
        <img src="${h}" @nc-click={this.toImg} />
        <img src="${u}" @nc-click={this.toImg} />
        <img src="${x}" @nc-click={this.toImg} />
        <img src="${f}" @nc-click={this.toImg} />
      </nc-carousel>
    `}toImg(r){console.log(this,r)}}e("nc-carousel-ex5",g);class p extends t{template(){return`
    ...
    `}change(r){console.log(r.detail)}}e("nc-carousel-ex6",p);class m extends t{template(){return`
    <div>
      <h2>轮播图-Carousel</h2>
      <h3>例子</h3>
    ...
    `}getPropData(){return a}getEventData(){return n}}e("nc-ex-carousel",m);export{m as default};
//# sourceMappingURL=api-CIqrrEGi.js.map
