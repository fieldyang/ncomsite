import{p as t,c as s}from"./index-BVt-tjJk.js";import"./example-C2ydmLYP.js";import"./proptable-uCA8z-r8.js";import"./eventtable-BHpIrfds.js";import"./methodtable-DD90VFEj.js";import"./configtable-63OMejiF.js";import"./code-C6NeMfhG.js";import"./filecode-DVjfyq2s.js";const i=[{key:"1",name:"value",desc:"滑块当前值",type:"number",default:"0"},{key:"2",name:"show-tooltip",desc:"是否显示提示框",type:"boolean",default:"false"},{key:"3",name:"size",desc:"滑块尺寸",type:"string",default:"medium"},{key:"4",name:"color",desc:"滑块颜色",type:"string",default:"#409eff"},{key:"5",name:"min",desc:"最小值",type:"number",default:"0"},{key:"6",name:"max",desc:"最大值",type:"number",default:"100"},{key:"7",name:"step",desc:"步长",type:"number",default:"1"},{key:"8",name:"disabled",desc:"是否禁用",type:"boolean",default:"false"},{key:"9",name:"show-ticks",desc:"是否显示刻度",type:"boolean",default:"false"},{key:"10",name:"show-input",desc:"是否显示输入框",type:"boolean",default:"false"}],o=[{key:"1",name:"nc-change",desc:"滑块值改变时触发",params:"e: CustomEvent<{ value: number }>"}];class r extends s{constructor(){super()}template(){return`
      <nc-slider value="35" style="width: 100%; margin-bottom: 50px;"></nc-slider>
      <nc-slider value="67" style="width: 100%;" show-tooltip></nc-slider>
    `}}t("nc-slider-ex1",r);class c extends s{constructor(){super()}template(){return`
    ...
    `}}t("nc-slider-ex2",c);class a extends s{constructor(){super()}template(){return`
    ...
    `}}t("nc-slider-ex3",a);class d extends s{constructor(){super()}template(){return`
    ...
    `}getPropData(){return i}getEventData(){return o}}t("nc-ex-slider",y);export{y as default};
//# sourceMappingURL=api-C6ScXf6y.js.map
