import{p as t,c as l}from"./index-BVt-tjJk.js";import"./example-C2ydmLYP.js";import"./proptable-uCA8z-r8.js";import"./methodtable-DD90VFEj.js";import"./eventtable-BHpIrfds.js";import"./filecode-DVjfyq2s.js";const o=[{key:"1",name:"type",desc:"提示框类型",type:"success|warning|error|info",default:"info"},{key:"2",name:"message",desc:"提示框文本内容",type:"string",default:"-"},{key:"3",name:"closable",desc:"是否显示关闭按钮",type:"boolean",default:"false"},{key:"4",name:"show-icon",desc:"是否显示类型图标",type:"boolean",default:"true"},{key:"5",name:"visible",desc:"是否显示提示框（受控属性）",type:"boolean",default:"true"}],i=[{key:"1",name:"show",desc:"显示提示框",params:"-",returns:"void"},{key:"2",name:"hide",desc:"隐藏提示框",params:"-",returns:"void"}],x=[{key:"1",name:"nc-close",desc:"提示框关闭时触发的自定义事件",params:"e: CustomEvent<{ type: AlertType }>"}];class p extends l{template(){return`
    ...
    `}}t("nc-alert-ex1",p);class d extends l{template(){return`
    ...
    `}}t("nc-alert-ex2",d);class m extends l{template(){return`
      <nc-alert type="success" message="成功提示（无图标）" closable show-icon="false"></nc-alert>
      <nc-alert type="warning" message="警告提示（无图标）" closable show-icon="false"></nc-alert>
      <nc-alert type="error" message="错误提示（无图标）" closable show-icon="false"></nc-alert>
      <nc-alert type="info" message="信息提示（无图标）" closable show-icon="false"></nc-alert>
    `}}t("nc-alert-ex3",m);class h extends l{template(){return`
      <nc-alert type="success" closable>
        <strong>自定义成功提示：</strong> 这是插槽内容
      </nc-alert>
    `}}t("nc-alert-ex4",h);class g extends l{template(){return`
    ...
    `}getControlledAlert(){return this.shadowRoot?this.shadowRoot.querySelector("#controlled-alert"):null}handleToggleAlertType(){const e=this.getControlledAlert();if(!e)return;const r=e.type,a=["success","warning","error","info"],c=(a.indexOf(r)+1)%a.length,s=a[c];e.type=s,e.message=`已切换为${s}类型提示`,console.log("提示框类型切换为：",s)}handleToggleAlertIcon(){const e=this.getControlledAlert();e&&(e.showIcon=!e.showIcon,console.log("提示框图标显隐状态：",e.showIcon))}handleHideAlert(){const e=this.getControlledAlert();e&&(e.hide(),console.log("提示框已隐藏"))}handleShowAlert(){const e=this.getControlledAlert();e&&(e.show(),console.log("提示框已显示"))}}t("nc-alert-ex5",g);class u extends l{template(){return`
    ...
    <div>
      ...
      <ex-instance label='3.隐藏图标'>
        <div slot='desc'>show-icon="false" 隐藏类型图标，仅显示文本内容</div>
...
//# sourceMappingURL=api-CsdNUACI.js.map
