import{o as c,r,t as a,h as d}from"./index-BeqiT-cc.js";const t=[{id:"0",label:"开发导引",url:"/doc/develop/conceipt",active:!0},{id:"1",label:"表达式",url:"/doc/develop/expression"},{id:"2",label:"事件",url:"/doc/develop/event"},{id:"3",label:"路由",url:"/doc/develop/router"},{id:"4",label:"颜色",url:"/doc/develop/color"}];class u extends c{template(){return`
      <style>
        :host{
          overflow:hidden;
          flex:1;
...
//# sourceMappingURL=developindex-CajMJKIV.js.map
