import{h as t,o as n}from"./index-ByWvHBFy.js";import"./example-zfEWff3B.js";import"./proptable-DtLqTi3X.js";import"./eventtable-BDFvsiWo.js";import"./methodtable-0caEftew.js";import"./index-CjIDkcmk.js";const a=[{key:"1",name:"placeholder",desc:"输入框占位提示文本",type:"string",default:"-"},{key:"2",name:"value",desc:"输入框绑定值",type:"string",default:"-"},{key:"3",name:"clearable",desc:"显示清空按钮，无值属性",type:"-",default:"-"},{key:"4",name:"disabled",desc:"禁用输入框，无值属性",type:"-",default:"-"},{key:"5",name:"type",desc:"输入框类型",type:"text | password | textarea | number",default:"text"},{key:"6",name:"slot",desc:"前后缀插槽（prefix/suffix）",type:"string",default:"-"},{key:"7",name:"readonly",desc:"只读输入框，无值属性",type:"-",default:"-"},{key:"8",name:"step",desc:"number 类型步长",type:"number",default:"1"},{key:"9",name:"min",desc:"number 类型最小值",type:"number",default:"-"},{key:"10",name:"max",desc:"number 类型最大值",type:"number",default:"-"}],i=[{key:"1",name:"focus",desc:"使输入框获得焦点",params:"-",returns:"void"},{key:"2",name:"blur",desc:"使输入框失去焦点",params:"-",returns:"void"},{key:"3",name:"select",desc:"选中输入框中的文本",params:"-",returns:"void"},{key:"4",name:"clear",desc:"清空输入框（会触发 nc-change）",params:"-",returns:"void"},{key:"5",name:"setValueSilent",desc:"静默设置值，不触发 nc-change",params:"next: string(新值)",returns:"void"}],p=[{key:"1",name:"nc-change",desc:"值发生确认变化事件（失焦或步进等提交时）",params:"e: CustomEvent<{ value: string; oldValue: string }>"},{key:"2",name:"nc-input",desc:"值实时变化事件",params:"e: CustomEvent<{ value: string }>"},{key:"3",name:"nc-focus",desc:"获得焦点事件",params:"e: CustomEvent<{ value: string }>"},{key:"4",name:"nc-blur",desc:"失去焦点事件",params:"e: CustomEvent<{ value: string }>"},{key:"5",name:"nc-keydown",desc:"按键按下事件",params:"e: CustomEvent<{ value: string }>"},{key:"6",name:"nc-enter",desc:"按下 Enter 时触发",params:"e: CustomEvent<{ value: string }>"}];class c extends n{template(){return`
    ...
    `}}t("nc-input-ex2",s);function d(){return[{value:"com",label:".com"},{value:"cn",label:".cn"},{value:"org",label:".org"},{value:"net",label:".net"}]}class u extends n{template(){return`
      <div>
        <h4>前后缀插槽示例</h4>
    ...
    `}genDomain(){return d()}handleSearch(){alert("搜索按钮点击！"),console.log("执行搜索操作")}}t("nc-input-ex3",u);class o extends n{template(){return`
      <div>
        <h4>禁用状态示例</h4>
    ...
    `}}t("nc-input-ex4",o);class r extends n{template(){return`
      <div>
        <h4>密码框/文本域示例</h4>
    ...
    `}}t("nc-input-ex6",x);class h extends n{template(){return`
      <div>
    ...
    `}connectedCallback(){super.connectedCallback(),this.inputEl=this.shadowRoot?.querySelector(".controlled")}handleChange(e){console.log("change 事件:",e.detail)}handleInput(e){console.log("input 事件:",e.detail)}handleFocus(e){console.log("focus 事件:",e.detail)}handleBlur(e){console.log("blur 事件:",e.detail)}handleKeydown(e){console.log("key down:",e.detail)}changeNumber(e){console.log("change number:",e.detail)}}t("nc-input-ex8",m);class v extends n{template(){return`
    <div>
      <h2>输入框-Input</h2>
      <h3>例子</h3>
    ...
    `}getPropData(){return a}getMethodData(){return i}getEventData(){return p}}t("nc-ex-input-api",v);export{v as default};
//# sourceMappingURL=api-B-uFVn0T.js.map
