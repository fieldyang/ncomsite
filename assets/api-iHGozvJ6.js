import{h as e,o as t}from"./index-BeqiT-cc.js";import"./example-0mRrsaOf.js";import"./proptable-COxNg4Rl.js";import"./eventtable-CfynLuIM.js";import"./methodtable-DJ4g9pMm.js";import"./configtable-Bw9BrCp8.js";import"./code-BCdWtaC3.js";import"./index-CjIDkcmk.js";const r=[{key:"1",name:"header",desc:"卡片头部内容（字符串形式，优先级低于 header 具名插槽）",type:"string",default:"-"},{key:"2",name:"footer",desc:"卡片底部内容（字符串形式，优先级低于 footer 具名插槽）",type:"string",default:"-"},{key:"3",name:"body-style",desc:"自定义 body 部分的样式",type:"string",default:"-"},{key:"4",name:"shadow",desc:"卡片阴影出现的时机",type:"string",default:"always"}];class o extends t{constructor(){super()}template(){return`
    ...
    `}}e("nc-card-ex1",o);class n extends t{constructor(){super()}template(){return`
      <nc-card style="max-width: 480px">
        <p style="margin-bottom: 10px; font-weight: 500;" >臭豆腐</p>
        <p style="margin-bottom: 10px; font-weight: 500;" >螺蛳粉</p>
        <p style="margin-bottom: 10px; font-weight: 500;" >榴莲</p>
    ...
    `}}e("nc-card-ex2",n);class d extends t{constructor(){super()}template(){return`
      <div>
    ...
    `}}e("nc-card-ex3",d);class p extends t{constructor(){super()}template(){return`
      <div>
        <nc-card style="max-width: 480px; margin-bottom: 10px;">
    ...
    `}}e("nc-card-ex4",p);class c extends t{template(){return`
    <div>
      <h2>卡片-Card</h2>
      <h3>例子</h3>
    ...
    `}getPropData(){return r}}e("nc-ex-card",c);export{c as default};
//# sourceMappingURL=api-iHGozvJ6.js.map
