import{h as o,o as a}from"./index-BeqiT-cc.js";import"./example-0mRrsaOf.js";import"./proptable-COxNg4Rl.js";import"./eventtable-CfynLuIM.js";import"./index-CjIDkcmk.js";const s=[{key:"1",name:"value",desc:"当前选中项的值",type:"string | number",default:"-",options:"-"},{key:"2",name:"items",desc:"选项配置数组",type:"RadioGroupItem[]",default:"[]",options:"-"},{key:"3",name:"disabled",desc:"是否禁用整组，无值属性",type:"-",default:"-"}],p=[{key:"1",name:"nc-change",desc:"选中值改变时触发",params:"e:CustomEvent"}];function r(e,i=[]){const n=[];for(let t=0;t<e;t++)n.push({value:t,label:`option${t}`,disabled:i.includes(t)});return n}class d extends a{template(){return`
...
//# sourceMappingURL=api-Dp3254cu.js.map
