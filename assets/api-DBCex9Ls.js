import{p as e,c as t}from"./index-BVt-tjJk.js";import"./example-C2ydmLYP.js";import"./proptable-uCA8z-r8.js";import"./eventtable-BHpIrfds.js";import"./methodtable-DD90VFEj.js";import"./configtable-63OMejiF.js";import"./code-C6NeMfhG.js";import"./filecode-DVjfyq2s.js";const i=[{key:"1",name:"direction",desc:"弹出方向",type:"string",default:"right",options:"left,right,top,bottom"},{key:"2",name:"width",desc:"宽度",type:"string",default:"300px",options:"-"},{key:"3",name:"height",desc:"高度",type:"string",default:"300px",options:"-"},{key:"4",name:"title",desc:"抽屉标题",type:"string",default:"-",options:"-"}],a=[{key:"1",name:"nc-open",desc:"抽屉打开时触发",params:"e: CustomEvent"},{key:"2",name:"nc-close",desc:"抽屉关闭时触发",params:"e: CustomEvent"}];class l extends t{constructor(){super(),this.drawerLeft=null,this.drawerRight=null,this.drawerTop=null,this.drawerBottom=null,this.drawerLeft=this.root.querySelector("#drawer-left"),this.drawerRight=this.root.querySelector("#drawer-right"),this.drawerTop=this.root.querySelector("#drawer-top"),this.drawerBottom=this.root.querySelector("#drawer-bottom")}template(){return`
    <div style="display: flex; gap: 15px; flex-wrap: wrap;">
      ...
      <nc-drawer id="drawer-left" title="左侧抽屉" direction="left" size="300px">
          这是从左侧弹出的抽屉
      </nc-drawer>

      <nc-drawer id="drawer-right" title="右侧抽屉" direction="right" size="300px">
          这是从右侧弹出的抽屉
      </nc-drawer>

      <nc-drawer id="drawer-top" title="顶部抽屉" direction="top" size="300px">
          这是从顶部弹出的抽屉
      </nc-drawer>

      <nc-drawer id="drawer-bottom" title="底部抽屉" direction="bottom" size="300px">
          这是从底部弹出的抽屉
      </nc-drawer>
    </div>
    ...
    <div style="display: flex; gap: 15px; flex-wrap: wrap;">
      ...
      <nc-drawer id="drawer-small" title="小尺寸抽屉" direction="right" size="250px">
          紧凑的小尺寸抽屉，适合简短内容
      </nc-drawer>

      <nc-drawer id="drawer-medium" title="中等尺寸抽屉" direction="right" size="450px">
          适中的尺寸，适合大多数场景
      </nc-drawer>

      <nc-drawer id="drawer-large" title="大尺寸抽屉" direction="right" size="70%">
          宽敞的大尺寸抽屉，适合复杂内容
      </nc-drawer>
    </div>
    ...
    <div style="display: flex; gap: 15px; flex-wrap: wrap;">
      ...
      <nc-drawer id="drawer-form" title="创建新项目" direction="right" width="500px">
      ...
      <nc-drawer id="drawer-scroll" title="内容滚动示例" direction="right" size="400px">
...
//# sourceMappingURL=api-DBCex9Ls.js.map
