const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./component2-BOJTb9nr.js","./index-jXIqD89d.js","./index-C5Satcps.css"])))=>i.map(i=>d[i]);
import{h as a,o as s,_ as r}from"./index-jXIqD89d.js";import"./example-QTzWMApy.js";import"./proptable-VeYFwaya.js";import"./eventtable-UsmbF0i9.js";import"./configtable-D34DvAyZ.js";import"./code-ly2ZbuUS.js";import"./index-CjIDkcmk.js";const p=[{key:"1",name:"items",desc:"标签项配置数组",type:"TabItemOption[]",default:"[]"},{key:"2",name:"style",desc:"组件样式",type:"string",default:"-"},{key:"3",name:"type",desc:"tab样式类型",type:"card|default",default:"default"},{key:"4",name:"vertical",desc:"是否纵向展示（无值属性）",type:"-",default:"-"},{key:"5",name:"tab-width",desc:"纵向模式下tab宽度",type:"string|number",default:"-"}],d=[{key:"1",name:"nc-change",desc:"tab切换事件",params:"e:CustomEvent,e.detail={oldKey:旧key,newKey:新key,oldData:旧数据,newData:新数据}"}],m=[{key:"1",name:"key",desc:"标签唯一标识",type:"string",mustfill:!0},{key:"2",name:"label",desc:"标签标题",type:"string",mustfill:!0},{key:"3",name:"component",desc:"标签内容组件",type:"CustomElementConstructor | Function",mustfill:!1},{key:"4",name:"html",desc:"标签内容 HTML",type:"string",mustfill:!1},{key:"5",name:"active",desc:"是否默认激活",type:"boolean",mustfill:!1},{key:"6",name:"closable",desc:"是否可关闭",type:"boolean",mustfill:!1}];class x extends s{template(){return`
      <h3>
      这是component1
      </h3>
    `}}a("my-comp1",x);function c(t,e,n,l){const b=[];for(let i=1;i<=t;i++){const o={key:i+"",label:"tab"+i};l||(o.html=`<div>hello ,this is tab${i}.</div>`),e!==void 0&&i===e&&(o.active=!0),n&&(o.closable=!0),b.push(o)}return b}function u(){return[{key:"1",label:"页签1",html:"<div>hello ,this is tab1</div>",closable:!0},{key:"2",label:"页签2",component:x},{key:"3",label:"页签3",html:"<div>hello ,this is tab3</div>",closable:!0},{key:"4",label:"页签4",component:()=>r(()=>import("./component2-BOJTb9nr.js"),__vite__mapDeps([0,1,2]),import.meta.url)}]}class h extends s{constructor(){super()}template(){return`
...
//# sourceMappingURL=api-R2V7NrqM.js.map
