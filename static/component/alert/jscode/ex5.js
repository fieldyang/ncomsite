...
export default class AlertEx5 extends NComponent {
  ...
  // 获取受控Alert实例
  private getControlledAlert(){
    if (!this.shadowRoot) return null;
    return this.shadowRoot.querySelector("#controlled-alert");
  }
  ...
  handleToggleAlertType() {
    ...
    const currentType = alertEl.type;
    const typeList= ["success", "warning", "error", "info"];
