      ...
      <div>
        <nc-form label-width="120" label-align="right" dataSource={this.model} colon star gap-row="8">
          <nc-row>
            ...
            <nc-col span="6">
              <nc-form-item label="分数" name="score" validator={{between,100]}} unit="分">
                <nc-input type="number"></nc-input>
              </nc-form-item>
            </nc-col>
          </nc-row>
          ...
          <nc-row>
            <nc-col span="6">
              <nc-form-item label="昵称" name="nickname" validator={{betweenLength,12]}}>
                <nc-input></nc-input>
              </nc-form-item>
            </nc-col>
            <nc-col span="6">
          ...
          <nc-form-item label="时间" name="workTime" validator="time">
            <nc-input placeholder="HH:mm="width: 200px;"></nc-input>
          </nc-form-item>
        </nc-form>
