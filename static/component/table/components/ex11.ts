import { NComponent, defineComponent, NCTable, TableColumn, NCPagination, ChangeEventDetail } from "@ncom/all";
...
export default class Table11 extends NComponent {
  ...
  connectedCallback(): void {
    ...
    this.table = this.root as NCTable;
    this.pagination = this.root?.querySelector("nc-pagination") as NCPagination;
    this.changePage();
  }
